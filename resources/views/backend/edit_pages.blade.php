@extends('backend.layouts.main', ['title' => 'Edit Pages'])
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('pages.update', $page->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="x" type="hidden" name="content" value="{{ old('content', $page->content) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="status_aktif" value="aktif"
                                {{ old('status', $page->status) == 'aktif' ? 'checked' : '' }} required>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="status" id="status_tidak_aktif"
                                value="tidak" {{ old('status', $page->status) == 'tidak' ? 'checked' : '' }} required>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="menu_id" id="menu_id" class="form-select" required>
                            ...
                            @foreach ($menu as $m)
                                <option value="{{ $m->id }}"
                                    {{ old('menu_id', $page->menu_id) == $m->id ? 'selected' : '' }}>
                                    {{ $m->name }}</option>
                            @endforeach
                        </select>
                    </div>
